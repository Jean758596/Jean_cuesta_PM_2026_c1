...
/* Lluvias.
El programa calcula el promedio mensual de lluvias en tres regiones
(Golfo, Pacífico y Caribe) y determina cuál tiene mayor promedio anual.
*/

void Mayor(float, float, float);   // Prototipo
...
int main(void)
{
    ...
    Mayor(AGOL, APAC, ACAR);   // Paso por valor
